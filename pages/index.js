    ...
    <div className="min-h-screen flex flex-col bg-base-100">
      ...
      <main className="flex-grow container mx-auto p-8">
        <section className="mb-16 text-center animate-fade-in">
          <h2 className="text-5xl font-bold mb-4 text-base-content">Welcome to RAVANA AGI</h2>
          <p className="mb-8 max-w-3xl mx-auto text-lg text-neutral-content">
        ...
        <section className="animate-slide-in-up" style={{ animationDelay: '0.2s' }}>
          <h3 className="text-3xl font-bold mb-6 text-center text-base-content">Explore Topics</h3>
