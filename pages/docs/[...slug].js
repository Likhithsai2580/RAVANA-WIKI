...
export default function DocPage({ doc, docs }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-base-100">
      ...
      <header className="bg-base-200/80 backdrop-blur-lg sticky top-0 z-50 py-4 px-4 md:px-6 shadow-lg border-b border-base-300 animate-slide-in-up">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent animate-gradient-shift">RAVANA AGI</h1>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <nav className="hidden md:block">
              <ul className="flex space-x-4">
                <li><Link href="/" className="hover:text-primary transition-colors duration-300 hover:animate-pulse">Home</Link></li>
              </ul>
            </nav>
      ...
      <div className="flex-grow container mx-auto px-4 py-6 md:py-8 flex flex-col md:flex-row gap-6 animate-fade-in">
        ...
        <main className="flex-grow overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-6 h-full">
            <article className="prose max-w-none bg-base-200 p-4 md:p-6 rounded-lg shadow-xl flex-grow border border-base-300 transition-all duration-300 hover:shadow-2xl overflow-y-auto max-h-[calc(100vh-8rem)] hover-glow animate-zoom-in">
              <h1 className="text-wiki-text-light mb-6 pb-2 border-b border-wiki-border animate-fade-in">{doc.title}</h1>
      ...
      <footer className="bg-base-200 text-base-content py-6 px-4 md:px-6 border-t border-base-300 animate-fade-in">
